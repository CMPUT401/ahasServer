class Contact < ApplicationRecord
  bbefore_save { email.downcase! }
  
  validates :first_name, presence: { message: 'First Name is required' }, length: { maximum: 25, message: 'Name is too long' }

  validates :last_name, presence: { message: 'Last Name is required' }, length: { maximum: 25, message: 'Name is too long' }
