...
define('ahasweb/components/history-container', ['exports', 'ember'], function (exports, _ember) {
	exports['default'] = _ember['default'].Component.extend({
		...
		actions: {
			...
			showLabResults: function showLabResults() {
				this.set('chronoIsVisible', false);
				this.set('medicationIsVisible', false);
				this.set('labResultIsVisible', true);
				this.set('vaccineIsVisible', false);
			},
			showVaccine: function showVaccine() {
				// console.log("show medication, the id is " + patientId);
				this.set('chronoIsVisible', false);
				this.set('medicationIsVisible', false);
				this.set('labResultIsVisible', false);
...
define('ahasweb/components/lab-result-history', ['exports', 'ember'], function (exports, _ember) {
	exports['default'] = _ember['default'].Component.extend({
		isVisible: false,
		patientId: 0,
		ajax: _ember['default'].inject.service(),
		...
		actions: {
			...
			viewEntry: function viewEntry(labResultID) {
		...
		init: function init() {
			...
			var ajaxGet = new _ember['default'].RSVP.Promise(function (resolve) {
				return _this.get('ajax').request('api/patients/' + _this.patientId + '/images').then(function (data) {
...
define('ahasweb/components/vaccine-history', ['exports', 'ember'], function (exports, _ember) {
	exports['default'] = _ember['default'].Component.extend({
		isVisible: false,
		patientId: 0,
		ajax: _ember['default'].inject.service(),
...
define('ahasweb/controllers/radiography-upload', ['exports', 'ember'], function (exports, _ember) {
	exports['default'] = _ember['default'].Controller.extend({
		loadedFile: null,
		session: _ember['default'].inject.service(),
		ajax: _ember['default'].inject.service(),
		actions: {
			...
			sendRadiographyResults: function sendRadiographyResults(patientId) {
...
define("ahasweb/controllers/view-patient", ["exports", "ember"], function (exports, _ember) {
    exports["default"] = _ember["default"].Controller.extend({
        actions: {
            newEntry: function newEntry(patientId) {
...
define('ahasweb/helpers/app-version', ['exports', 'ember', 'ahasweb/config/environment', 'ember-cli-app-version/utils/regexp'], function (exports, _ember, _ahaswebConfigEnvironment, _emberCliAppVersionUtilsRegexp) {
...
define('ahasweb/mirage/config', ['exports'], function (exports) {
  exports['default'] = function () {
    ...
    */
    ...
    this.get('/patients/:id/medical_records', function () {
      return {
        success: true,
        medical_records: []
      };
    ...
    this.get('/patients/:id/medications', function () {
      return {
        success: true,
        medications: [{
          id: 1,
...
define("ahasweb/routes/radiography-upload", ["exports", "ember"], function (exports, _ember) {
	exports["default"] = _ember["default"].Route.extend({
		init: function init() {
			checkFileApiSupport();
			//document.getElementById('files').addEventListener('change', handleFileSelect, false);
...
define('ahasweb/routes/view-image-record', ['exports', 'ember', 'ember-simple-auth/mixins/authenticated-route-mixin'], function (exports, _ember, _emberSimpleAuthMixinsAuthenticatedRouteMixin) {
	exports['default'] = _ember['default'].Route.extend({
		session: _ember['default'].inject.service(),
		ajax: _ember['default'].inject.service(),
		model: function model(param) {
			...
			//ajax get request to populate field
			var ajaxGet = new _ember['default'].RSVP.Promise(function (resolve) {
				return _this.get('ajax').request('/api/patients/' + param.patientID + "/images/" + param.imageID).then(function (data) {
					console.log("data is " + JSON.stringify(data));
					_ember['default'].run(function () {
						resolve({
...
define("ahasweb/templates/components/history-container", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "WDYFTGkj", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"new-entry-button-wrapper\"],[\"flush-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"button\",[]],[\"static-attr\",\"class\",\"new-entry-button\"],[\"modifier\",[\"action\"],[[\"get\",[null]],\"newEntry\",[\"get\",[\"model\",\"id\"]]]],[\"flush-element\"],[\"text\",\"New Entry\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"close-element\"],[\"text\",\"\\n\"],[\"append\",[\"helper\",[\"patient-history\"],null,[[\"isVisible\",\"patientId\"],[[\"get\",[\"chronoIsVisible\"]],[\"get\",[\"patientID\"]]]]],false],[\"text\",\"\\n\"],[\"append\",[\"helper\",[\"medication-history\"],null,[[\"isVisible\",\"patientId\"],[[\"get\",[\"medicationIsVisible\"]],[\"get\",[\"patientID\"]]]]],false],[\"text\",\"\\n\"],[\"append\",[\"helper\",[\"lab-result-history\"],null,[[\"isVisible\",\"patientId\"],[[\"get\",[\"labResultIsVisible\"]],[\"get\",[\"patientID\"]]]]],false],[\"text\",\"\\n\"],[\"append\",[\"helper\",[\"vaccine-history\"],null,[[\"isVisible\",\"patientId\"],[[\"get\",[\"vaccineIsVisible\"]],[\"get\",[\"patientID\"]]]]],false],[\"text\",\"\\n\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"history-selector\"],[\"flush-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"button\",[]],[\"static-attr\",\"class\",\"history-selector-button\"],[\"modifier\",[\"action\"],[[\"get\",[null]],\"showChronological\"]],[\"flush-element\"],[\"text\",\"Chronological\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"button\",[]],[\"static-attr\",\"class\",\"history-selector-button\"],[\"modifier\",[\"action\"],[[\"get\",[null]],\"showMedication\"]],[\"flush-element\"],[\"text\",\"Medication History\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"button\",[]],[\"static-attr\",\"id\",\"vaccine-component-button\"],[\"static-attr\",\"class\",\"history-selector-button\"],[\"modifier\",[\"action\"],[[\"get\",[null]],\"showVaccine\"]],[\"flush-element\"],[\"text\",\"Vaccine History\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"button\",[]],[\"static-attr\",\"class\",\"history-selector-button\"],[\"modifier\",[\"action\"],[[\"get\",[null]],\"showLabResults\"]],[\"flush-element\"],[\"text\",\"Lab Results\"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "ahasweb/templates/components/history-container.hbs" } });
});
define("ahasweb/templates/components/lab-result-history", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "lormNOkC", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"new-entry-button-wrapper\"],[\"flush-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"button\",[]],[\"static-attr\",\"class\",\"new-entry-button\"],[\"modifier\",[\"action\"],[[\"get\",[null]],\"uploadResult\"]],[\"flush-element\"],[\"text\",\"Upload Lab Result\"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\t\\n\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"infoBlockComponent\"],[\"flush-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"panel panel-default\"],[\"flush-element\"],[\"text\",\"\\t\\t\\n\\t\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"history-list\"],[\"static-attr\",\"style\",\"overflow:auto\"],[\"flush-element\"],[\"text\",\"\\n\"],[\"block\",[\"each\"],[[\"get\",[\"labResultList\"]]],null,0],[\"text\",\"\\t\\t\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"\\t\\t\\t\\t\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"nameListItem\"],[\"modifier\",[\"action\"],[[\"get\",[null]],\"viewEntry\",[\"get\",[\"labEntry\",\"imageId\"]]]],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\\t\\t\\n\\t\\t\\t\\t\\t\\t\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"append\",[\"unknown\",[\"labEntry\",\"name\"]],false],[\"text\",\" \"],[\"append\",[\"unknown\",[\"labEntry\",\"date\"]],false],[\"close-element\"],[\"text\",\"\\n\\t\\t\\t\\t\\t\\t\\n\\t\\t\\t\\t\\t\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[\"labEntry\"]}],\"hasPartials\":false}", "meta": { "moduleName": "ahasweb/templates/components/lab-result-history.hbs" } });
});
define("ahasweb/templates/components/medication-history", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "Af7iZoR4", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"infoBlockComponent\"],[\"flush-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"panel panel-default\"],[\"flush-element\"],[\"text\",\"\\t\\t\\n\\t\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"history-list\"],[\"static-attr\",\"style\",\"overflow:auto\"],[\"flush-element\"],[\"text\",\"\\n\"],[\"block\",[\"each\"],[[\"get\",[\"medicationList\"]]],null,0],[\"text\",\"\\t\\t\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"\\t\\t\\t\\t\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"nameListItem\"],[\"modifier\",[\"action\"],[[\"get\",[null]],\"viewEntry\",[\"get\",[\"entry\",\"medical_record_id\"]]]],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\\t\\t\\n\\t\\t\\t\\t\\t\\t\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"append\",[\"unknown\",[\"entry\",\"name\"]],false],[\"text\",\" \"],[\"append\",[\"unknown\",[\"entry\",\"date\"]],false],[\"close-element\"],[\"text\",\"\\n\\t\\t\\t\\t\\t\\t\\n\\t\\t\\t\\t\\t\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[\"entry\"]}],\"hasPartials\":false}", "meta": { "moduleName": "ahasweb/templates/components/medication-history.hbs" } });
});
...
define("ahasweb/templates/components/vaccine-history", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "cjIgiqtF", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"infoBlockComponent\"],[\"flush-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"panel panel-default\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"history-list\"],[\"static-attr\",\"style\",\"overflow:auto\"],[\"flush-element\"],[\"text\",\"\\n\"],[\"block\",[\"each\"],[[\"get\",[\"vaccineList\"]]],null,0],[\"text\",\"\\t\\t\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"\\t\\t\\t\\t\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"nameListItem vaccineList\"],[\"modifier\",[\"action\"],[[\"get\",[null]],\"viewEntry\",[\"get\",[\"entry\",\"medical_record_id\"]],[\"get\",[\"entry\",\"date\"]]]],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\\t\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\" \"],[\"append\",[\"unknown\",[\"entry\",\"name\"]],false],[\"text\",\" \"],[\"append\",[\"unknown\",[\"entry\",\"dateToDisplay\"]],false],[\"close-element\"],[\"text\",\"\\n\\t\\t\\t\\t\\t\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[\"entry\"]}],\"hasPartials\":false}", "meta": { "moduleName": "ahasweb/templates/components/vaccine-history.hbs" } });
});
...
define("ahasweb/templates/radiography-upload", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "TYQTRYAM", "block": "{\"statements\":[[\"open-element\",\"form\",[]],[\"modifier\",[\"action\"],[[\"get\",[null]],\"sendRadiographyResults\",[\"get\",[\"model\",\"patientId\"]]],[[\"on\"],[\"submit\"]]],[\"flush-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"panel panel-default\"],[\"flush-element\"],[\"text\",\"\\n\"],[\"block\",[\"file-picker\"],null,[[\"fileLoaded\",\"readAs\"],[\"fileLoaded\",\"readAsDataURL\"]],0],[\"text\",\"\\t\"],[\"close-element\"],[\"text\",\"\\n\\t\\t\\n\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"fileDatePicker\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\"],[\"append\",[\"helper\",[\"bootstrap-datepicker\"],null,[[\"id\",\"value\",\"autoclose\",\"placeholder\",\"class\",\"required\"],[\"datePicker\",[\"get\",[\"datePicker\"]],true,\"Date of radiography\",\"form-control\",true]]],false],[\"text\",\"\\n\\t\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"button\",[]],[\"static-attr\",\"type\",\"submit\"],[\"static-attr\",\"id\",\"saveRadiography\"],[\"static-attr\",\"class\",\"saveFileButton\"],[\"flush-element\"],[\"text\",\"Save\"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"\\t\\t\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"fileDropZone\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\tDrag here or click to upload a file\\n\\t\\t\\t\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "ahasweb/templates/radiography-upload.hbs" } });
});
...
define("ahasweb/templates/view-image-record", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "+g18EM9L", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"flush-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"File Name: \"],[\"append\",[\"unknown\",[\"model\",\"name\"]],false],[\"close-element\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Record Type: \"],[\"append\",[\"unknown\",[\"model\",\"type\"]],false],[\"close-element\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"This was made on: \"],[\"append\",[\"unknown\",[\"model\",\"date\"]],false],[\"close-element\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"imageContainer\"],[\"flush-element\"],[\"append\",[\"unknown\",[\"model\",\"imgData\"]],true],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "ahasweb/templates/view-image-record.hbs" } });
});
...
if (!runningTests) {
  require("ahasweb/app")["default"].create({"name":"ahasweb","version":"0.0.0+92bb5848"});
}
